...
studies_to_update = {
    'good_shepherd_001': {
        'file': 'good_shepherd_tl_001.json',
        'reading_minutes': 7
    },
    'temple_cleansing_001': {
        'file': 'temple_cleansing_tl_001.json',
        'reading_minutes': 7
    },
    'woman_at_well_001': {
        'file': 'woman_at_well_tl_001.json',
        'reading_minutes': 6
    },
    'natanael_fig_tree_001': {
        'file': 'natanael_fig_tree_tl_001.json',
        'reading_minutes': 6
    },
    'cana_wedding_001': {
        'file': 'cana_wedding_tl_001.json',
        'reading_minutes': 5
    },
    'i_am_before_abraham_001': {
        'file': 'i_am_before_abraham_tl_001.json',
        'reading_minutes': 7
    }
}
